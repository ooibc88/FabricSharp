...
type Receiver interface {
	...
	scheduleMsg(msg *cb.Envelope) bool
	Cut() []*cb.Envelope
}
...
func NewReceiverImpl(sharedConfigFetcher OrdererConfigFetcher, scheduler scheduler.Scheduler) Receiver {
	return &receiver{
...
//   - impossible
//
// Note that messageBatches can not be greater than 1
